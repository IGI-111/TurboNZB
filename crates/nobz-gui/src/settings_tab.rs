    ...
    egui::ScrollArea::vertical().show(ui, |ui| {
        ...
        ui.collapsing("Add server", |ui| {
            ui.horizontal(|ui| {
                ...
                ui.checkbox(&mut state.new_server.tls, "TLS");
            });
            ui.horizontal(|ui| {
            ...
            ui.horizontal(|ui| {
                ui.label("Connections:");
                ui.add(egui::DragValue::new(&mut state.new_server.max_connections).range(1..=100));
                ui.label("Priority:");
        ...
        ui.collapsing("Add indexer", |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                ui.label("Priority:");
                ui.add(egui::DragValue::new(&mut state.new_indexer.priority).range(0..=100));
            });
            ui.horizontal(|ui| {
                if ui.button("Test").clicked() {
                    backend.send(BackendCmd::TestIndexer {
        ...
        // --- Categories ---
        ui.heading("Category → Subfolder Mapping");
        ...
        ui.heading("Post-processing Defaults");
        ...
        if ui
            .checkbox(&mut pp.skip_verify, "Skip PAR2 verification")
            .changed()
        {
            changed = true;
        }
        if ui
            .checkbox(&mut pp.cleanup_archives, "Delete archives after unpack")
            .changed()
        {
            changed = true;
        }
