//! TurboNBZ GUI library (eframe app).
//!
...
use turbonbz_core::queue::JobState;

const ORG_NAME: &str = "turbonbz";
const APP_NAME: &str = "turbonbz";
...
impl eframe::App for TurboNzbApp {
...
pub fn run() -> Result<()> {
    ...
    tracing::info!("TurboNBZ GUI starting");
    ...
    eframe::run_native(
        "TurboNBZ",
        native_options,
        Box::new(|cc| Ok(Box::new(TurboNzbApp::new(cc)))),
    )
