...
//!
//! Usage:
//!   nobz-search --indexer "Name1=https://url1/api:apikey1" \
//!              --indexer "Name2=https://url2/api:apikey2" \
//!              --query "some search" [--tv --season 1 --episode 5] [--movie --imdb tt0058935]

use clap::{Parser, ValueEnum};
use nobz_index::aggregate::SearchAggregator;
use nobz_index::newznab::NewznabClient;
use nobz_index::types::*;
...
#[derive(Parser)]
#[command(name = "nobz-search", about = "Newznab search CLI harness")]
struct Cli {
