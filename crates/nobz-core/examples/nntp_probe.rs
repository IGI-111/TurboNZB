...
//!
//! Reads the first server from the real config (`~/.config/nobz/config.json`
...
//! Usage:
//! ```text
//! cargo run -p nobz-core --example nntp_probe -- --conns 8 --seconds 10
//! cargo run -p nobz-core --example nntp_probe -- --config /path/to/config.json
//! ```
