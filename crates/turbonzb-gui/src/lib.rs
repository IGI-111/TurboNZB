//! TurboNZB GUI library (eframe app).
//!
...
use turbonzb_core::queue::JobState;

const ORG_NAME: &str = "turbonzb";
const APP_NAME: &str = "turbonzb";
...
pub fn run() -> Result<()> {
    ...
    tracing::info!("TurboNZB GUI starting");
